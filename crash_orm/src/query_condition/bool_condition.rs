...
pub trait BoolQueryColumn<T: ToSql, U: Entity<U, PRIMARY>, PRIMARY: PrimaryKey> {
...
impl<U: Entity<U, PRIMARY>, R: Column<bool, U, PRIMARY>, PRIMARY: PrimaryKey> BoolQueryColumn<bool, U, PRIMARY> for R {
    fn is_true(&self) -> QueryCondition<U, PRIMARY> {
