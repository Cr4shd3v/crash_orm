...
use crate::{Column, Entity, PrimaryKeyType, QueryCondition};

/// Trait implementing true/false checks
pub trait BoolQueryColumn<T: ToSql, U: Entity<U, P>, P: PrimaryKeyType> {
...
impl<U: Entity<U, P>, R: Column<bool, U, P>, P: PrimaryKeyType> BoolQueryColumn<bool, U, P> for R {
    fn is_true(&self) -> QueryCondition<U, P> {
