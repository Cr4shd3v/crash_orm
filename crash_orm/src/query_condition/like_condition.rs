...
pub trait LikeQueryColumn<T: ToSql, U: Entity<U, PRIMARY>, PRIMARY: PrimaryKey<'static>> {
...
impl<U: Entity<U, PRIMARY>, R: Column<String, U, PRIMARY>, PRIMARY: PrimaryKey<'static>> LikeQueryColumn<String, U, PRIMARY> for R {
    fn like(&self, like: impl IntoSql<String>) -> QueryCondition<U, PRIMARY> {
