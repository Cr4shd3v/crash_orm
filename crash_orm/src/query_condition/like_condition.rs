...
pub trait LikeQueryColumn<T: ToSql, U: Entity<U, P>, P: PrimaryKeyType> {
...
impl<U: Entity<U, P>, R: Column<String, U, P>, P: PrimaryKeyType> LikeQueryColumn<String, U, P> for R {
    fn like(&self, like: impl IntoSql<String>) -> QueryCondition<U, P> {
