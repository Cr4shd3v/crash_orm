...
use crate::{Column, Entity, QueryCondition, BoundColumnValue};

/// Trait implementing like operators
pub trait LikeQueryColumn<T: ToSql, U: Entity<U>> {
    fn like(&self, like: &(dyn BoundColumnValue<String>)) -> QueryCondition<U>;

    fn not_like(&self, like: &(dyn BoundColumnValue<String>)) -> QueryCondition<U>;
}
