...
use crate::{BoxedColumnValue, DatabaseConnection, Entity, PrimaryKeyType, QueryCondition};
...
pub struct EntityColumn<T: ToSql, U: Entity<U, P>, P: PrimaryKeyType> {
    name: &'static str,
...
impl<T: ToSql, U: Entity<U, P>, P: PrimaryKeyType> EntityColumn<T, U, P> {
