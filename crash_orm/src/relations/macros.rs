...
macro_rules! sql_impl_for_relation {
    ($rel_type:tt) => {
        impl<T: Entity<T, P>, P: PrimaryKey> tokio_postgres::types::ToSql for $rel_type<T, P> {
            fn to_sql(
                &self,
        ...
        impl<'a, T: Entity<T, P>, P: PrimaryKey + tokio_postgres::types::FromSql<'a>> tokio_postgres::types::FromSql<'a> for $rel_type<T, P> {
